...
MIDL_INTERFACE("e0982f6b-41d7-4a1f-8aa9-cecb15da2360")
IDXGIVkSwapChainHud : public IDXGIVkSwapChain2 {
  virtual HRESULT STDMETHODCALLTYPE SetHudData(
    const DXGI_VK_HUD_DATA*         pData) = 0;

  // Last successfully submitted VkPresentModeKHR, or MAX_ENUM if unavailable.
  virtual UINT STDMETHODCALLTYPE GetPresentMode() = 0;
};
...
__CRT_UUID_DECL(IDXGIVkSwapChainHud,       0xe0982f6b,0x41d7,0x4a1f,0x8a,0xa9,0xce,0xcb,0x15,0xda,0x23,0x60);
