...
namespace dxvk {
  using NTSTATUS = LONG;
  constexpr NTSTATUS D3DKMT_STATUS_NOT_IMPLEMENTED = static_cast<NTSTATUS>(0xc0000002u);
...
#define D3DKMT_WINE_CPU_TELEMETRY_V1_SIZE      40
  ...
  static_assert(sizeof(D3DKMT_WINE_GPU_TELEMETRY) == D3DKMT_WINE_GPU_TELEMETRY_V1_SIZE);
  static_assert(sizeof(D3DKMT_WINE_CPU_TELEMETRY) == D3DKMT_WINE_CPU_TELEMETRY_V1_SIZE);
